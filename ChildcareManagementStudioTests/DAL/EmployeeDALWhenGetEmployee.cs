...
namespace ChildcareManagementStudioTests.DAL
{
    ...
    public class EmployeeDALWhenGetEmployee
    {
        ...
        {
            int employeeId = -1;
            Assert.ThrowsException<System.ArgumentException>(() => employeeDAL.GetEmployee(employeeId));
        }
