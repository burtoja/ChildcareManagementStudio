...
{
    /// <summary>
    /// Class for testing the GetAllAccountHolders method of the AccountHolderController class.
    /// Note that this is only a temporary test class.
    /// These tests are based on the current state of the production database.
    /// </summary>
    [TestClass]
    public class AccountHolderControllerWhenGetAllAccountHolders
    {
        [TestMethod]
        public void ShouldReturnAllEmployees()
        {
            ...
            List<AccountHolder> accountHolders = accountHolderController.GetAllAccountHolders();
